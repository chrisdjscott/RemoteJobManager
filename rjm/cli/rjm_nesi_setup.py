...
def make_parser():
    ...
    parser.add_argument('--skip-funcx', action="store_true", help="Skip setting up funcX on NeSI")
    parser.add_argument('--skip-globus', action="store_true", help="Skip setting up Globus for NeSI")
...
def nesi_setup():
    ...
    if not args.skip_funcx:
        nesi.setup_funcx()

    # if not args.skip_globus():
        # nesi.setup_globus()
