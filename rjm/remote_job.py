...
class RemoteJob:
    ...
    def __init__(self, timestamp=None):
        ...
        self._retry_tries = config.getint("RETRY", "tries", fallback=5)
        self._retry_backoff = config.getint("RETRY", "backoff", fallback=2)
        self._retry_delay = config.getint("RETRY", "delay", fallback=2)
